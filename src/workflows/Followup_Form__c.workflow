...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <template>unfiled$public/Followup_DCC_Template</template>
    </alerts>
    <fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>RecordType_to_Live</fullName>
        <field>RecordTypeId</field>
        <lookupValue>Live</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
        <name>RecordType to Live</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>LookupValue</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Record_Type_to_Approval_Pending</fullName>
        <field>RecordTypeId</field>
        <lookupValue>Approval_Pending</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
        <name>Record Type to Approval Pending</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>LookupValue</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>Status_to_Approval_Pending</fullName>
        <field>Status__c</field>
    ...
    <fieldUpdates>
        <fullName>Updating_Root_CRF_Followup</fullName>
        <field>Root_CRF_Id__c</field>
        <formula>CASESAFEID(Id)</formula>
        <name>Updating Root CRF Followup</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <rules>
        <fullName>Follow Up Merge Date</fullName>
        <actions>
            <name>Copy_Date</name>
    ...
    <rules>
        <fullName>Updating Root CRF Followup</fullName>
        <actions>
            <name>Updating_Root_CRF_Followup</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
