...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <template>unfiled$public/Chemo_Summary_DCC_Template</template>
    </alerts>
    <fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>Updating_Root_CRF_chemosummary</fullName>
        <field>Root_CRF_Id__c</field>
        <formula>CASESAFEID(Id)</formula>
        <name>Updating Root CRF chemosummary</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <rules>
        <fullName>Chemo Summary Merge Date</fullName>
        <actions>
            <name>Copy_Date</name>
    ...
    <rules>
        <fullName>Updating Root CRF chemosummary</fullName>
        <actions>
            <name>Updating_Root_CRF_chemosummary</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
