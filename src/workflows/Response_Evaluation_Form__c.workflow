...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <template>unfiled$public/Response_DCC_Template</template>
    </alerts>
    <fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>Updating_Root_CRF_ResponseForm</fullName>
        <field>Root_CRF_Id__c</field>
        <formula>CASESAFEID(Id)</formula>
        <name>Updating Root CRF ResponseForm</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <rules>
        <fullName>Response Merge Date</fullName>
        <actions>
            <name>Copy_Date</name>
    ...
    <rules>
        <fullName>Updating Root CRF ResponseForm</fullName>
        <actions>
            <name>Updating_Root_CRF_ResponseForm</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
